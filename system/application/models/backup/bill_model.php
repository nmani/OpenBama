...
(SELECT   action_type
    ...
    function get_most_viewed_bill($session) {
        ...
        $sql = 'SELECT b.*,openbama.get_bill_page_view_count(b.id) AS page_view_count
                FROM bills b
    ...
    function get_most_popular_bill($session) {
        ...
        $sql = 'SELECT b.*,openbama.Get_bill_popularity(b.id) AS popular
                FROM bills b
                WHERE session_identifier = ?
    ...
    function get_popular_bill($session) {
        ...
        $sql = 'SELECT b.*,openbama.get_bill_popularity(b.id) AS bill_popularity
                FROM bills b
                WHERE session_identifier = ?
