<div id="most_popular_help_div" class="tip">
            ...
            <h3>Most Popular Bill <a href="#" onmouseout="popUp(event,'most_popular_help_div')" onmouseover="popUp(event,'most_popular_help_div')" onclick="return false"><img border="0" src="<?php echo base_url().'img/questionmark.png'; ?>" width="15" height="15" /></a></h3><a href="<?php echo base_url().'index.php/bill/display/'.$popular_bill->id; ?>">
                <u>
